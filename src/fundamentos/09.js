...
class SearchInput extends React.Component {
  constructor() {
    ...
    this.handleInputInternational = this.handleInputInternational.bind(this);
    this.handleInputPreferred = this.handleInputPreferred.bind(this);
  ...
  handleInputInternational(ev) {
    this.setState({ international: ev.target.checked });
  }
  handleInputPreferred(ev) {
    ...
    return (
      <form onSubmit={this.handleSubmit} className="searchForm">
        ...
        <p>
          <label>
            <input
              onChange={this.handleInputInternational}
              checked={this.state.international}
              type="checkbox" /> Incluir artistas internacionales
          </label>
        </p>
        <p>
          <label>
            <input
              onChange={this.handleInputPreferred}
              checked={this.state.preferred}
              type="checkbox" /> Incluir preferidos
          </label>
        </p>
      </form>
    );
